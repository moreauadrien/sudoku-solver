...
<div class="tool" on:click={handleClick}>
    {#if name == 'candidates'}
        <Candidates width={35} height={35} color={color}/>
    {:else if name == 'hint'}
        <Hint width={35} height={35} color={color} />
    {:else if name == 'check'}
        <Check width={25} height={25} color={color} />
    {:else if name == 'solve'}
        <Solve width={25} height={25} color={color} />
    {:else if name == 'erase'}
        <Erase width={25} height={25} color={color} />
    {/if}
